  ...
  return `
    <div class="header-inner">
      ...
      <nav class="header-nav" id="header-nav" role="navigation" aria-label="Main navigation">
        ...
        <a href="https://github.com/lhp620/Algebra2" target="_blank" rel="noopener" class="nav-link">GitHub</a>
        <a href="https://github.com/lhp620/Algebra2/issues" target="_blank" rel="noopener" class="nav-link">Report Bug</a>
      ...
      <div class="header-right">
        ...
        <div class="nav-progress" title="Overall Progress" aria-label="Overall progress">
          ...
          <span id="header-progress-text" aria-label="Lessons mastered">0/63</span>
        </div>

// app.js — Algebra 2 Interactive Learning SPA
...
const STREAK_KEY  = 'alg2_streak_v1';
...
function renderHomePage() {
  ...
  document.getElementById('main-content').innerHTML = `
    <section class="hero">
      <div class="container">
        <div class="hero-badge">✦ Algebra 2 Mastery</div>
        <h1>Learn Algebra 2<br>Step by Step</h1>
        <p class="hero-subtitle">
          11 units · 63 lessons · worked examples · practice problems with instant feedback
        </p>
...
async function renderLessonPage(lessonId) {
  ...
  const accent     = ACCENTS[unitId] || '#7c3aed';
  ...
  main.innerHTML = `
    <div style="padding:48px 0 80px">
      <div class="container">
        ...
        <p style="color:var(--color-text-muted);margin-bottom:32px">All key Algebra 2 formulas. Search by topic, unit, or keyword.</p>
        <div class="formula-search">
          <span class="search-icon">🔍</span>
          <input type="text" id="formula-search-input"
                 placeholder="Search formulas… (e.g. quadratic, slope, logarithm)"
